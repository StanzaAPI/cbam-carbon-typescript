...
exports.CbamCarbonClient = void 0;





class CbamCarbonClient {
  constructor(config = {}) {
    ...
    this.baseUrl = config.baseUrl || 'https://api.stanzaapi.com/cbam-carbon';
    this.validateEndpoint = '/api/v1/calculate';
    this.parseEndpoint = '/api/v1/calculate';
    this.toolUrl = 'https://stanzaapi.com/tools/cbam-carbon';
  }
...
exports.CbamCarbonClient = CbamCarbonClient;
exports.default = CbamCarbonClient;
